...
![Relationship of Wage and Employee Number](images/fig_example1.jpg){height="85%" width="85%"}
...
![Trend of Wage and Consumption](images/fig_example3.jpg){height="85%" width="85%"}
 ...
 ![Income Patterns with Certain Group Method](images/fig_example4.jpg){height="85%" width="85%"}
 
 - Try to group the data according to one-dimensional bins, as well as n-dimensional clusters. 
 
  ![Some Group Methods to Find Paterns](images/fig_example2.jpg){height="85%" width="85%"}
