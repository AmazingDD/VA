...
The data of our group project is the project dataset provided by the official 2022 VAST challenge. Here is the data download link: [https://bit.ly/VAST-Challenge-2022-data](https://bit.ly/VAST-Challenge-2022-data)
 ...
 - **`Participants.csv`**: contains information about the residents of Engagement and Happiness index that have agreed to participate in this study. 
 - **`Employers.csv`**: records information about the companies and businesses within the city limits that either employ study participants, or which have available job openings. 
 - **`Buildings.csv`**: Contains information about the buildings in the city that were involved in this study; this includes commercial, residential and school properties. 
 - **`Pubs.csv`**: contains information about the pubs within the city limits.
...
Over the period covered by the dataset, which businesses appear to be more prosperous? Which appear to be struggling? Describe your rationale for your answers.
 ...
 ![Relationship of Wage and Employee Number](images/fig_example1.jpg){height="65%" width="65%"}
...
![Trend of Wage and Consumption](images/fig_example3.jpg){height="65%" width="65%"}
 ...
 ![Income Patterns with Certain Group Method](images/fig_example4.jpg){height="65%" width="65%"}
 
 - Try to group the data according to one-dimensional bins, as well as n-dimensional clusters. 
 
  ![Some Group Methods to Find Paterns](images/fig_example2.jpg){height="65%" width="65%"}
...
![Ohio Turnover/Revenue Heatmap](images/fig_example5.jpeg){height="80%" width="80%"}
